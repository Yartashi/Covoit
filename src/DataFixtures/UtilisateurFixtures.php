...
class UtilisateurFixtures extends Fixture 
{
    ...
    public function load(ObjectManager $manager) : void
    {
        ...
        $utilisateur4->setNom("Cousine")
        ->setPrenom("Becasine")
        ->setmail("becasine.ta.cousine@wanadoo.fr")
        ->setNumTel("0632618606")
        ->setMdp("mdp")
        ->setAdresse("somewhere");
        ...
        $utilisateur5->setNom("Peyronnel")
        ->setPrenom("Pauline")
        ->setmail("popey@gmail.fr")
